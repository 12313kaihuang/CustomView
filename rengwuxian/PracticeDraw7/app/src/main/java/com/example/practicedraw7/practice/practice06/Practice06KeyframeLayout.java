package com.example.practicedraw7.practice.practice06;
...
import com.example.practicedraw7.R;
    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe startFrame = Keyframe.ofFloat(0, 0);
                Keyframe midFrame = Keyframe.ofFloat(0.8f, 100);
                Keyframe endFrame = Keyframe.ofFloat(1f, 80);
                PropertyValuesHolder propertyValuesHolder = PropertyValuesHolder.ofKeyframe("progress", startFrame, midFrame, endFrame);
                ObjectAnimator.ofPropertyValuesHolder(view, propertyValuesHolder).setDuration(2000).start();
            }
        });
    }
}
